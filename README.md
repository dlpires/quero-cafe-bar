...
- **Proteção Global:** `JwtAuthGuard` (todas as rotas exceto login), `ThrottlerGuard`, `helmet`
...
- [x] Testes unitários completos (149 testes, 22 suites)
...
- [x] Testes unitários (216 testes, 20 suites)
...
| `yarn test` | Jest unit tests (149 testes, 22 suites) |
...
| `npm test` | Jest unit tests (216 testes, 20 suites) |
