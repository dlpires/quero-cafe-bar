...
- **Produto**: Itens do cardápio. Listagens precisam de infinite scroll e swipe-to-delete.
- **Usuario**: Funcionários (admin/garçom). Listagens precisam de infinite scroll e swipe-to-delete.
- **Mesa**: Mesas do estabelecimento. Listagens precisam de infinite scroll e swipe-to-delete.
- **Comanda**: Pedidos abertos por mesa. Listagens precisam de infinite scroll e pull-to-refresh (na cozinha).

## Success Criteria

### Measurable Outcomes

- **SC-001**: Listas com mais de 50 registros carregam progressivamente sem congelamento da interface — o usuário pode começar a interagir com os primeiros itens enquanto o restante carrega
...
- **SC-006**: Gestos touch (swipe, pull-to-refresh) não conflitam com scroll vertical da página — scroll continua funcionando normalmente ao deslizar para cima/baixo sem movimento lateral significativo
